...
class Author:
    ...
    def get_all(cls):
        ...
        authors_from_db = connectToMySQL('book_schema').query_db(query)
        authors = []
    ...
    @classmethod
    def create(cls, data ):
        query = "INSERT INTO authors (name) VALUES (%(name)s, NOW() , NOW() );"
        return connectToMySQL('book_schema').query_db(query, data)
    
    @classmethod
    def get_all_unfavotited_authors(cls):
    ...
    def get_by_id(cls,data):
        ...
        results = connectToMySQL('book_schema').query_db(query,data)
